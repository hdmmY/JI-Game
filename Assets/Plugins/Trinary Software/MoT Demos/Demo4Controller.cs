...
namespace MovementDemos
{
    public class Demo4Controller : MonoBehaviour
    {
        ...
        private static void AssignEasingBasedOnIndex<T>(int index, ref Effect<Transform, T> effect)
        {
            ...
            {
                default:
                    effect.CalculatePercentDone = null;
                    break;
                case 0:
                    effect.CalculatePercentDone = Easing.SineIn;
                    break;
                case 1:
                    effect.CalculatePercentDone = Easing.SineOut;
                    break;
                case 2:
                    effect.CalculatePercentDone = Easing.SineInOut;
                    break;
                case 3:
                    effect.CalculatePercentDone = Easing.ElasticIn;
                    break;
                case 4:
                    effect.CalculatePercentDone = Easing.ElasticOut;
                    break;
                case 5:
                    effect.CalculatePercentDone = Easing.ElasticInOut;
                    break;
                case 6:
                    effect.CalculatePercentDone = Easing.BounceIn;
                    break;
                case 7:
                    effect.CalculatePercentDone = Easing.BounceOut;
                    break;
                case 8:
                    effect.CalculatePercentDone = Easing.BounceInOut;
                    break;
                case 9:
                    effect.CalculatePercentDone = Easing.BackIn;
                    break;
                case 10:
                    effect.CalculatePercentDone = Easing.BackOut;
                    break;
                case 11:
                    effect.CalculatePercentDone = Easing.BackInOut;
                    break;
                case 12:
                    effect.CalculatePercentDone = Easing.Pow2In;
                    break;
                case 13:
                    effect.CalculatePercentDone = Easing.Pow2Out;
                    break;
                case 14:
                    effect.CalculatePercentDone = Easing.Pow2InOut;
                    break;
                case 15:
                    effect.CalculatePercentDone = Easing.Pow3In;
                    break;
                case 16:
                    effect.CalculatePercentDone = Easing.Pow3Out;
                    break;
                case 17:
                    effect.CalculatePercentDone = Easing.Pow3InOut;
                    break;
                case 18:
                    effect.CalculatePercentDone = Easing.Pow4In;
                    break;
                case 19:
                    effect.CalculatePercentDone = Easing.Pow4Out;
                    break;
                case 20:
                    effect.CalculatePercentDone = Easing.Pow4InOut;
                    break;
                case 21:
                    effect.CalculatePercentDone = Easing.Pow5In;
                    break;
                case 22:
                    effect.CalculatePercentDone = Easing.Pow5Out;
                    break;
                case 23:
                    effect.CalculatePercentDone = Easing.Pow5InOut;
                    break;
            }
